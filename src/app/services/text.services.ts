  ...
  public getEndorsementEvents(): Event[] {
    const results: Event[] = [
      ...
      },
      {
        ...
        history: 'This was a big endorsement coming after referendums in Kansas and Ohio that proved even red states care about the issue of reproductive rights',
