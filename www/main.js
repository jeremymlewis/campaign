...
const routes = [
    {
        path: '',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_intro-page_intro_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./intro-page/intro.module */ 4956)).then(m => m.IntroModule)
    },
    {
        path: 'options',
